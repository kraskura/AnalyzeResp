...
textFileConvert<-function(txt_file,
  ...
  # DO unit convert functions adopted from CRAN archive: https://cran.r-project.org/src/contrib/Archive/rMR/
  #

  #'uses in Eq.Ox.conc below
  Barom.Press <-
...
# **** ^^^ imported functions from depracated rMR package to support unit conversions
# *****************************************************************
