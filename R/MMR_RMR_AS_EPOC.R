#' Title
#'
#' @param data.MMR The name of the MMR data file (“…analyzed.csv”; a character string); an output file from the MMR function. When unavailable, enter "none"
#' @param data.SMR The name of the SMR data file (“…analyzed.csv”; a character string); an output file from the SMR function. When unavailable, enter "none"
...
#' @param mmr_type Currently an unused argument
...
#' @param path Defines the directory to save output files. Two options: i) exports are saved in the currently set working directory, or ii) prior-defined directories as created by function organize_MR_analysis
#'
...
# 		}
        ...
        plotname.mlnd<-paste("../plots_mlnd_SMR/", filename.SMR,"_", Y.Ch, "_MLND_SMR_analysed.png", sep="")
    	}
