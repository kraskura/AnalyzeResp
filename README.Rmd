...
- Clean the code and get syntax under control. (some argumants have "." in names, while some have "_" in their names). Carryover of old not good practices of coding 
...
- Revise exported data files and make sure each column of data is neccessary, revise accordingly. 
- Improve, label, plots
